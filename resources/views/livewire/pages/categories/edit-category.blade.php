<div class="cont">
    ...
    @else
        @foreach($competitions as $key => $competition)
            <div wire:key="{{$key}}" class="tournament">
                <h3 class="text-white text-center text-xl">Раунд {{$key + 1}}</h3>
                <div class="tournament__grid">
                    <div class="tournament__round">
                        <div class="tournament__match hover:border-gray-300">
                            <a class="tournament__match__team "
                    ...
                    <div class="tournament__round tournament__round--winner">
                        <div class="tournament__match">
                            <a class="tournament__match__team" href=" {{route('contestants.circle', [
                                                'tournament' => $tournament,
                                                'category' => $category,
                                                'competition' => $competition,
                                                ])}}">
                                @if(!empty($winners[$competition->id]))
                                    {{$winners[$competition->id]->getFullName()}}
                                @else
                                    FINAL
                                @endif
                            </a>
